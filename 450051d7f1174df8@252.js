...
import define1 from "./4caee69e966109c8@32.js"; //controls DOM disposals
...
md`The *alternate* option, which defaults to false, specifies whether the animation should reverse direction when it reaches the end, rather than repeat from the start.`
  ...
  main.variable(observer()).define(["Scrubber","numbers"], function(Scrubber,numbers){return(
Scrubber(numbers, {loop: false, alternate: false})
)});
...
function Scrubber(values, {
  format = value => value,
  initial = 0, //0 determines starting position, and currently going by 10's, e.g. <9.5 = 2000, 170 = 2017, >=180 = 2018
  delay = 200, //null time between transitions, 'specifies how long to wait between frames in milliseconds.'
